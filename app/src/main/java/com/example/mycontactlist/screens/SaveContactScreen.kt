...
import com.example.mycontactlist.domain.model.NEW_CONTACT_ID
import com.example.mycontactlist.domain.model.TagModel
import com.example.mycontactlist.routing.PhoneNumberRouter
import com.example.mycontactlist.routing.Screen
import com.example.mycontactlist.ui.components.ContactColor
import com.example.mycontactlist.util.fromHex
    ...
    TopAppBar(
        ...
        actions = {
            ...
            IconButton(onClick = onOpenTagPickerClick) {
                Icon(
                    painter = painterResource(id = R.drawable.ic_baseline_brush_24),
...
private fun SaveContactContent(
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        val isChecked: Boolean = contact.isVerify
        ...
        FavoriteCheckOption(
            ...
            onCheckedChange = { FavoriteNewValue ->
                ...
                onContactChange.invoke(contact.copy(isVerify = isCheckedOff))
            }
        )
        ContentTextField(
            label = "Name",
...
private fun FavoriteCheckOption(
    ...
    Row(
        ...
        Text(
            text = "Is this Contact is verify?",
