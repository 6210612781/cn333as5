package com.example.mycontactlist.ui.components
...
private fun LightDarkThemeItem() {
    Row(
        ...
        Switch(
            checked = MycontactlistThemeSettings.isDarkThemeEnabled,
            onCheckedChange = { MycontactlistThemeSettings.isDarkThemeEnabled = it },
            modifier = Modifier
...
fun AppDrawer(
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        ScreenNavigationButton(
            ...
            label = "Verifly Contacts",
            isSelected = currentScreen == Screen.Contacts,
            onClick = {
                PhoneNumberRouter.navigateTo(Screen.Verify)
                closeDrawerAction()
            }
        )
        ScreenNavigationButton(
